...
Console.WriteLine($"Сумма положительных чисел = {getSumPositiveNegativeElem[1]}");
Console.WriteLine($"Сумма отрицательных чисел = {getSumPositiveNegativeElem[0]}");
